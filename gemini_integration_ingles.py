...
# Chave da API
api_key = "AIzaSyCJ6hrO2-p6S6Rv1IBC3FAGwyDsJAmkyFE"  # Substitua pela sua chave da Google API

def ask_gemini_ingles(historico):
                ...
                "parts": [
                    {
                        "text": f"Considere o seguinte histórico de conversa: {historico}."
                                 "Interaja como o 'DIA', um mentor que ensina pessoas a falarem inglês. Então interaja em portugues do brasil, mas traga essa experiência de aprender inglês para o usuário"
                                 "Caso o usuário interaja em inglês, siga a interação nessa lingua, mas faça as devidas correções da gramática e forma de falar"
